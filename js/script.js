...
function mapElements () {
    ...
    florDaVida = document.querySelector("#florDaVida")

    inputRangeRed.addEventListener('change', handInputRangeChange)
    inputRangeGreen.addEventListener('change', handInputRangeChange)
    inputRangeBlue.addEventListener('change', handInputRangeChange)
}

function handInputRangeChange (event) {
...
function syncDiv() {
    ...
    //headColor.style.color = `rgb(${r},${g},${b})`;
    //cicle.style.backgroundColor = `rgb(${r},${g},${b})`;
    florDaVida.style.borderColor = `rgb(${r},${g},${b})`;
    florDaVida.style.backgroundImage = `rgb(${r},${g},${b})`;
